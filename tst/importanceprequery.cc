...
// it calculate the queries using importance sampling and compare the results with the true ones
...
int main(int argc, char **argv)
{
	...
	int numofsamples = ParamInt("NumSamples",1000000);
     Sampler *sampler;
     ExpMethod method;
	...
	if (testing_result == 0)
		cout << "PASS importanceprequery unittest." << endl;
